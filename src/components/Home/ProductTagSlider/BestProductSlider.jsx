...
const BestProductSlider = ({ showQuickView }) => {
  ...
  const renderProductRows = () => {
    const rows = [];
    for (let i = 0; i < BestSellerProduct.length; i += 3) {
      const productInRow = BestSellerProduct.slice(i, i + 3);
      rows.push(
        <div key={i}>
              ...
              <div className="col-12" key={product.id}>
                <div className="product-box-4 wow fadeInUp">
                  ...
                  <div className="product-details">
                    <a href={product.slug}>
                      <h4 className="name">
                        {product.name && product.name.substring(0, 35)}
                      </h4>
                    </a>
                    <h5 className="price">
                      ₹{product.price}
