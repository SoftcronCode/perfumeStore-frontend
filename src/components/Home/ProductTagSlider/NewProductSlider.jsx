...
const NewProductSlider = ({ showQuickView }) => {
  ...
  const renderProductRows = () => {
    const rows = [];
    for (let i = 0; i < newProduct.length; i += 3) {
      const productInRow = newProduct.slice(i, i + 3);
      rows.push(
        <div key={i}>
              ...
              <div className="col-12" key={product.id}>
                <div className="product-box-4 wow fadeInUp">
                  ...
                  <div className="product-details">
                    <a href={product.slug}>
                      <h4 className="name">{product.name && product.name.substring(0, 40)}</h4>
                    </a>
