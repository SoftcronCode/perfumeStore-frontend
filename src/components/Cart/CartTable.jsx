            ...
            <tbody>
              {cartItems && cartItems.length > 0 ? (
                  ...
                  <tr className="product-box-contain" key={cart.cart_id}>
                    <td className="product-detail w-50">
                      <div className="product border-0">
                        <a href="!#" className="product-image w--30">
                          <img
                            src={`${PRODUCT_IMG_BASE_URL}${cart.product_image}`}
                          ...
                          <ul>
                            ...
                            <li className="d-block d-lg-none">
                              <h5 className="saving theme-color">
                                Saving : ₹
                                {cart.product_mrp - cart.product_price}
                              </h5>
                            </li>
                            ...
                            <li className="d-block d-lg-none mt-2">
                              <a
                                className="text-danger close_button"
                                href="javascript:void(0)"
                                onClick={async () => {
                                  const cartQty = await RemoveCartItem(
                                    cart.cart_id
                                  );
                                  if (cartQty) {
                                    setCartQty(cartQty);
                    ...
                    <td className="price text-center w--10 d-none d-lg-table-cell">
                      ...
                      <h5 className="justify-content-center">
                        ₹{cart.product_price}{" "}
                        <del className="text-content">₹{cart.product_mrp}</del>
                      </h5>
                      <h6 className="text-success">
                        You Save : ₹{cart.product_mrp - cart.product_price}
                      </h6>
                    </td>
                    ...
                    <td className="save-remove text-center w--10 d-none d-lg-table-cell">
                      ...
                      <a
                        ...
                        href="javascript:void(0)"
                        onClick={async () => {
                          const cartQty = await RemoveCartItem(cart.cart_id);
                          if (cartQty) {
                            setCartQty(cartQty);
                          }
                        }}
                ...
                <div className="text-center">
                  <img
                    src="/assets/images/theme/empty-cart.png"
                    height={300}
                    width={300}
                    className="img-fluid"
                    alt="empty-cart"
                  ...
                  <div className="contain-404">
                    <h3 className="text-content">
                      ...
                      <br /> ahead & explore top categories.
                    </h3>
                    <Link
                      to="/"
                      className="btn btn-md text-white theme-bg-color mt-4 mx-auto width-fit-content"
                    >
                      Back To Home Screen
                    </Link>
                  </div>
